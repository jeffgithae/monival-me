...
export const PERMISSIONS = {
  ...
  MANAGE_BENEFICIARIES: [OrgRole.OWNER, OrgRole.ADMIN, OrgRole.ME_OFFICER, OrgRole.FINANCE, OrgRole.FIELD_OFFICER],
  ...
  MANAGE_DATA_COLLECTION: [OrgRole.OWNER, OrgRole.ADMIN, OrgRole.ME_OFFICER, OrgRole.FIELD_OFFICER],
  VIEW_DATA_COLLECTION: [OrgRole.OWNER, OrgRole.ADMIN, OrgRole.ME_OFFICER, OrgRole.FIELD_OFFICER, OrgRole.FINANCE, OrgRole.VIEWER],
  MANAGE_STAKEHOLDER_FEEDBACK: [OrgRole.OWNER, OrgRole.ADMIN, OrgRole.ME_OFFICER, OrgRole.FIELD_OFFICER],
  VIEW_STAKEHOLDER_FEEDBACK: [OrgRole.OWNER, OrgRole.ADMIN, OrgRole.ME_OFFICER, OrgRole.FIELD_OFFICER, OrgRole.FINANCE, OrgRole.VIEWER],
} as const;