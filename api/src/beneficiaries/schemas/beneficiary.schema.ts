...
export class Beneficiary {
  ...
  // persisted, used purely as an idempotency key for offline-sync batches —
  // if the same record is submitted twice (e.g. a retried sync after a flaky
  // connection), the second attempt is recognised and skipped rather than
  // creating a duplicate beneficiary.
...
// Mirrors the same pattern used on Activity — see activities/schemas/activity.schema.ts.
