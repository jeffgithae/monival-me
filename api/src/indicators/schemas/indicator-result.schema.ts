...
// ─── Indexes ──────────────────────────────────────────────────────────────────
IndicatorResultSchema.index({ organizationId: 1, reportingPeriodId: 1 });
IndicatorResultSchema.index({ organizationId: 1, indicatorId: 1 });
IndicatorResultSchema.index({ organizationId: 1, projectId: 1, reportingPeriodId: 1 });